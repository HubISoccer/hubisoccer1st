        ...
        html += `
            <div class="besoin-card" data-id="${j.id}">
                <div class="card-media">
                    <img src="${j.image || 'public/img/user-default.jpg'}" alt="${j.nom}">
    ...
    dons.forEach(d => {
        html += `
            <div class="besoin-card" data-id="${d.id}">
                <div class="card-media">
                    <img src="${d.image || 'public/img/tou1.jpg'}" alt="${d.titre}">
                </div>
                <div class="card-content">
                    <h3>${d.titre}</h3>
...
async function applyFilters() {
    ...
    if (type === 'joueur') {
        queryDons = queryDons.limit(0); // ne pas afficher les dons
...
// ===== SOU MISSION FORMULAIRE DE CONTACT =====
